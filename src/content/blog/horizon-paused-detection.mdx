...
description: "Run horizon:pause before a deploy, forget to resume, and jobs queue silently for hours. How to detect the paused state and automate the alert."
date: 2026-04-06
updated: 2026-07-15
...
See [crontinel.com/features](https://crontinel.com/features/) for the full list of Horizon states it monitors. If you're coming from Cronitor, [crontinel.com/vs/crontinel-vs-cronitor](https://crontinel.com/vs/crontinel-vs-cronitor/) covers why ping-based monitors structurally cannot catch the paused state the way Crontinel does.
