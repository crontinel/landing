---
title: "Laravel Horizon Workers Idle While Jobs Pile Up? 6 Causes (And Fixes)"
description: "Horizon says 'running' but workers sit idle while queue depth climbs. Here are the 6 real reasons this happens — supervisor misconfig, Redis timeouts, PHP-FPM limits — and how to fix each one."
date: 2026-04-07
