...
- [Laravel Cron Monitoring Across Multiple Microservices](/blog/laravel-cron-monitoring-multi-microservices/) — when you scale from one Docker container to multiple services, the monitoring challenge changes. This covers cross-service heartbeats, dependency-aware alerting, and queue depth tracking.
- [Monitoring Laravel Cron Jobs on Kubernetes](/blog/monitoring-kubernetes-cron-jobs/) — for teams running containers at scale with K8s CronJobs.
