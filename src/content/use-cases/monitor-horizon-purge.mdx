---
title: "horizon:purge Not Cleaning Jobs? Detect Silent Failures"
description: "horizon:purge can exit with code 0 while Redis memory keeps climbing. Here is exactly how to tell if it is actually working — and how to get alerted when it isn't."
date: 2026-06-22
---
