---
title: "How to Monitor php artisan schedule:run in Production"
description: "Monitor Laravel's schedule:run command in production so you catch missed executions, slow runs, and silent scheduler failures before the missed jobs pile up."
date: 2026-04-07
---
...
- [Laravel Octane doesn't run the scheduler (how to catch it)](/blog/laravel-octane-scheduler-not-running/)
