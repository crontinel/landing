...
- [Monitoring model:prune in Laravel production](/use-cases/monitor-model-prune) - catch stale data cleanup failures before disk fills up
- [Monitoring Spatie laravel-backup in production](/use-cases/monitor-db-backup) - detect silent backup failures before you need a restore
